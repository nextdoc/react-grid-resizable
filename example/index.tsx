...
const separatorCallbacks = {
  onDragStart: (event: MouseEvent) => {
    console.log('Started dragging separator:', event)
  },
  onDragEnd: (event: MouseEvent) => {
    console.log('Done dragging separator:', event)
  }
}
        ...
        <StyledRowsWrapper>
          <StyledRow initialHeight={100}>
            <StyledColsWrapper>
              ...
              <StyledCol style={{ backgroundColor: color[2] }}>1.3</StyledCol>
            </StyledColsWrapper>
          </StyledRow>
          <StyledRow initialHeight={150} style={{ backgroundColor: color[2] }}>
            Dragging the separator below will not change the size of the third
            row
          </StyledRow>
          <StyledRow initialHeight={300} top={false}>
            <StyledColsWrapper>
              <StyledCol style={{ backgroundColor: color[1] }}>3.1</StyledCol>
              <StyledCol>
                <StyledRowsWrapper>
                  <StyledRow
                    initialHeight={100}
          ...
          <StyledRow>
            <StyledColsWrapper>
              <StyledCol style={{ backgroundColor: color[0] }}>4.1</StyledCol>
              <StyledCol
                initialWidth={100}
                style={{ backgroundColor: color[1] }}
              >
              ...
              <StyledCol style={{ backgroundColor: color[2] }}>4.3</StyledCol>
            </StyledColsWrapper>
          </StyledRow>
        </StyledRowsWrapper>
      </Wrapper>
